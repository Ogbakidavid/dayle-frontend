            ...
            <CardContent className="space-y-8">
                <div className="space-y-4">
                    ...
                    {clarifications.length === 0 ? (
                        <p className="text-sm text-white/40">No clarifications logged for this milestone.</p>
                    ) : (
                ...
                <div className="space-y-4">
                    ...
                    {fileComments.length === 0 ? (
                        <p className="text-sm text-white/40">No file comments for this milestone yet.</p>
                    ) : (
                        <div className="space-y-3">
