            ...
            <header className="border-b border-zinc-800/50 py-4 px-6 bg-[#050505]/80 backdrop-blur-xl sticky top-0 w-full z-50">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    <Link href="/client" className="flex items-center gap-2 group transition-colors">
                        ...
                        <span className="text-sm font-black uppercase tracking-widest text-white/40 group-hover:text-white">Dashboard</span>
                    </Link>
                    <div className="flex items-center gap-3">
                        <span className="text-sm font-black text-white/20 uppercase tracking-[0.2em]">Account Center</span>
                ...
                <div className="flex flex-col md:flex-row gap-16">
                    ...
                    <aside className="md:w-64 flex-shrink-0">
                        <div className="mb-8">
                            ...
                            <p className="text-sm font-bold text-white/20 uppercase tracking-widest mt-2">Manage account preferences</p>
                        </div>
                        ...
                        <nav className="space-y-1">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={cn(
                                        "w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-sm font-black uppercase tracking-widest relative group",
                                        activeTab === tab.id
                        ...
                        <div className="mt-12 pt-8 border-t border-white/5">
                            <button className="flex items-center gap-3 px-3 py-2 text-sm font-black uppercase tracking-widest text-white/20 hover:text-red-400 transition-colors w-full">
                    ...
                    <section className="flex-1 max-w-2xl">
                            ...
                            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                <div className="flex items-end gap-6">
                                    ...
                                    <div className="pb-1">
                                        ...
                                        <p className="text-sm font-bold text-white/20 uppercase tracking-widest mt-1">PNG, JPG or GIF up to 10MB</p>
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8">
                                    <div className="space-y-2">
                                        <Label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] ml-1">Full Name</Label>
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] ml-1">Email Address</Label>
                                    ...
                                    <div className="space-y-2 sm:col-span-2">
                                        <Label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] ml-1">Company</Label>
                        ...
                        {activeTab === 'payment' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                <div className="flex items-center justify-between mb-2">
                                    <h3 className="text-sm font-black text-white uppercase tracking-[0.2em]">Cards on file</h3>
                                ...
                                <Button className="w-full py-6 bg-transparent border border-dashed border-white/5 hover:border-emerald-500/50 hover:bg-emerald-500/5 text-white/20 hover:text-emerald-500 transition-all rounded-xl font-black uppercase text-sm tracking-widest">
                        ...
                        {activeTab === 'security' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-sm font-black text-white uppercase tracking-[0.2em] mb-1">Change Password</h3>
                                        <p className="text-sm font-bold text-white/20 uppercase tracking-widest">Update your password to keep your account secure</p>
                                    </div>

                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            <Label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] ml-1">Current Password</Label>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                <Label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] ml-1">New Password</Label>
                                                <Input type="password" placeholder="••••••••" className="bg-zinc-900/50 border-zinc-800 text-zinc-200 focus:ring-1 focus:ring-emerald-500/50 h-11" />
                                            </div>
                                            <div className="space-y-2">
                                                <Label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] ml-1">Confirm New</Label>
                                                <Input type="password" placeholder="••••••••" className="bg-zinc-900/50 border-zinc-800 text-zinc-200 focus:ring-1 focus:ring-emerald-500/50 h-11" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-start justify-between p-5 bg-zinc-900/30 border border-zinc-800/50 rounded-xl hover:border-zinc-700 transition-all">
                                        <div className="flex gap-4">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-sm font-bold text-white/40 leading-relaxed max-w-md uppercase tracking-widest">Add an extra layer of security to your account with authenticator app verification</p>
                                                <div className="pt-2">
                                ...
                                <div className="pt-8 border-t border-zinc-900 space-y-4">
                                    <div className="flex items-center justify-between">
                                        <h3 className="text-sm font-black text-white uppercase tracking-[0.2em]">Active Sessions</h3>
                        ...
                        {activeTab === 'notifications' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                <div>
                                    <h3 className="text-sm font-black text-white uppercase tracking-[0.2em] mb-1">Notification Preferences</h3>
                                    <p className="text-sm font-bold text-white/20 uppercase tracking-widest">Manage how you receive updates about your account</p>
                                </div>

                                {/* Email Notifications */}
                                <div className="space-y-3">
                                    <h4 className="text-sm font-bold text-zinc-400 uppercase tracking-widest">Email Notifications</h4>
                                    ...
                                    {[
                                        ...
                                        <div key={item.id} className="flex items-center justify-between p-4 bg-zinc-900/30 border border-zinc-800/50 rounded-xl hover:border-zinc-700 transition-all">
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm font-bold text-white/20 uppercase tracking-widest mt-1">{item.desc}</p>
                                            </div>
                                            <Switch
                                ...
                                <div className="pt-6 border-t border-zinc-900 space-y-3">
                                    <h4 className="text-sm font-bold text-zinc-400 uppercase tracking-widest">Marketing</h4>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-zinc-900/30 border border-zinc-800/50 rounded-xl hover:border-zinc-700 transition-all">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm font-bold text-white/20 uppercase tracking-widest mt-1">Occasional emails about new features and improvements</p>
                                        </div>
                                        <Switch
                                    ...
                                    <div className="p-5 bg-zinc-900/30 border border-zinc-800/50 rounded-xl">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm font-bold text-white/20 uppercase tracking-widest mb-3">Notifications will be sent to: <span className="text-emerald-500/80">john@example.com</span></p>
