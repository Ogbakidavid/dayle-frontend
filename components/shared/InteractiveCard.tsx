...
export default function InteractiveCard({
  ...
  useEffect(() => {
    if (cvc.length > 0 && !isFlipped) {
      const timer = setTimeout(() => setIsFlipped(true), 0);
  ...
  return (
    <div
      className="perspective-1000 w-full max-w-[360px] h-[220px] mx-auto relative group cursor-pointer"
    ...
    >
      ...
      >
        {/* FRONT */}
        <div className="absolute inset-0 w-full h-full backface-hidden rounded-sm overflow-hidden shadow-2xl glass-card-front bg-linear-to-br from-gray-900 via-gray-800 to-black border border-white/10">
          ...
          <div className="relative z-10 p-6 flex flex-col justify-between h-full">
            <div className="flex justify-between items-start">
              {/* Chip */}
              <div className="w-12 h-9 rounded-sm bg-linear-to-br from-yellow-200 to-yellow-500 border border-yellow-600/50 shadow-inner flex items-center justify-center relative overflow-hidden">
              ...
              <div className="h-8 flex items-center">
                {cardType === "visa" && (
                  ...
                  >
                    <path
                      d="M18.8 2H30.2L27.8 17H16.4L18.8 2Z"
                      fill="#2566AF"
                      fillOpacity="0.3"
                    />
                    <path
                      d="M36.2 2H47.6L45.2 17H33.8L36.2 2Z"
                      fill="#2566AF"
                      fillOpacity="0.3"
                    />
                    <path
                      d="M10.4 17L6.2 36H17.6L21.8 17H10.4Z"
                      fill="#FFFFFF"
                    />
                    <text
                      x="2"
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  <span className="text-sm text-white-400  block">
                    Card holder
                  </span>
                ...
                <div className="space-y-1">
                  <span className="text-sm text-white-400  block text-right">
                    Expires
                  </span>
        ...
        {/* BACK */}
        <div
          className="absolute inset-0 w-full h-full backface-hidden rounded-sm overflow-hidden shadow-2xl bg-linear-to-bl from-gray-900 via-gray-800 to-black border border-white/10"
