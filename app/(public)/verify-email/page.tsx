            ...
            {[
              {
                ...
                text: "Email verification ensures you own this communication channel.",
              },
              {
                title: "Fraud Prevention",
                text: "We verify every account to maintain a trusted ecosystem.",
              },
              {
                title: "Next: Role Selection",
                text: "After verification, you'll choose your workspace role.",
              },
            ].map((item, i) => (
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="flex gap-3 justify-between">
              {otp.map((digit, index) => (
                <input
                  ...
                  className="w-14 h-16 bg-muted border border-white/10 rounded-2xl text-center text-2xl font-black text-white focus:border-emerald-500/50 focus:bg-white/8 focus:outline-none transition-all placeholder:text-gray-400"
                />
              ))}
            </div>
            ...
            <div className="text-center text-white/50 text-sm font-bold uppercase tracking-wide mt-6">
              {resendCooldown > 0 ? (
                <p>
                  Resend available in{" "}
                  <span className="text-emerald-500">{resendCooldown}s</span>
                </p>
              ) : (
                <p>
                  Didn't receive code?{" "}
