...
export const mockNotifications = {
    client: [
        ...
        { id: 3, type: 'payment', title: 'Payment Processed', message: '$2,500 has been transferred to escrow for "API Integration"', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString(), read: false },
        { id: 4, type: 'security', title: 'New Login Detected', message: 'Login from Chrome on MacBook Pro in New York, US', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(), read: false },
    ...
    freelancer: [
        ...
        { id: 3, type: 'payment', title: 'Payment Received', message: '$2,500 has been settled in your account', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString(), read: false },
        { id: 4, type: 'security', title: 'New Login Detected', message: 'Login from Chrome on MacBook Pro in New York, US', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(), read: false },
