...
const AmountInput = React.forwardRef<HTMLInputElement, AmountInputProps>(({ className, value, onChange, label, ...props }, ref) => {
    ...
    return (
        <div className="relative">
            <Input
                ...
                {...props}
            />
            <div className="absolute left-3 top-[38px] text-white font-black">$</div>
        </div>
    );
});
