        ...
        <div className="grid md:grid-cols-2 gap-6 p-4">
            ...
            <Card className="bg-[#111111] border-white/5 shadow-2xl overflow-hidden relative group rounded-sm">
                ...
                <CardContent className="p-8 relative z-10">
                    <div className="flex items-center gap-2 text-white/40 font-black uppercase tracking-[0.2em] text-xs mb-5">
                    ...
                    <div className="mt-8 flex items-center gap-3">
                        <div className="px-3 py-1 bg-emerald-500/10 rounded-full text-xs font-black text-emerald-500 uppercase tracking-widest border border-emerald-500/20 flex items-center gap-2">
