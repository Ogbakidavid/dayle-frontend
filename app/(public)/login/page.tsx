              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <Input
                    ...
                    className="bg-muted! border-white/10 h-16 rounded-2xl px-6 focus:border-emerald-500/50 focus:bg-white/5! focus:ring-0 transition-all text-white text-lg placeholder:text-white/50 tracking-[0.5em] text-center font-mono"
                  />
