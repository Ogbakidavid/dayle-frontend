...
import { MessageSquare, FileText, CheckCircle2, Info, ShieldCheck, AlertCircle, Cpu, type LucideIcon } from "lucide-react";
...
function EvidenceItem({ topLeft, topRight, title, body, metaLeft, metaRight }: EvidenceItemProps) {
    return (
...
export function EvidencePanel({ milestone, evidence }: EvidencePanelProps) {
