            ...
            <div className="relative z-10 w-full max-w-xl">
                ...
                <div className="bg-[#0a0a0a] border border-white/10 rounded-[40px] p-10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="space-y-8 relative z-10">
                        ...
                        <Button
                            onClick={() => router.push('/')}
                            className="w-full h-16 bg-white/[0.03] border border-white/10 hover:bg-white/[0.05] text-white font-black uppercase tracking-[0.2em] text-xs rounded-2xl transition-all"
                        >
                            Close Transmission
                        </Button>
                    </div>
