                    ...
                    <div className="space-y-8 relative z-10">
                        ...
                        {isVerified ? (
                            <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-center">
                                <p className="text-sm font-black text-emerald-500 uppercase tracking-wide mb-2">Financial Finality Reached</p>
                                <p className="text-sm font-bold text-white uppercase tracking-wide leading-relaxed font-['Poppins',sans-serif]">The objective requirements have been validated. Funds have been distributed to the recipient node.</p>
                            </div>
                        ) : isReview ? (
                            <div className="p-6 rounded-2xl bg-blue-500/10 border border-blue-500/20 text-center">
                                ...
                                <p className="text-sm font-bold text-white uppercase tracking-wide leading-relaxed font-['Poppins',sans-serif]">Our protocol is currently verifying the submitted evidence against the vault requirements.</p>
                            </div>
                        ) : (
                            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 text-center">
                                <p className="text-sm font-black text-white uppercase tracking-wide mb-2">Waiting for Submission</p>
                                <p className="text-sm font-bold text-white uppercase tracking-wide leading-relaxed font-['Poppins',sans-serif]">Payment is locked and secured. Recipient has not yet submitted work for verification.</p>
                            </div>
                        )}

                        <Button
                            onClick={() => router.push("/")}
                            className="w-full h-16 bg-white/3 border border-white/10 hover:bg-white/5 text-white font-black uppercase tracking-wide text-sm rounded-2xl transition-all"
                        >
                            Close Transmission
                        </Button>
                    </div>
