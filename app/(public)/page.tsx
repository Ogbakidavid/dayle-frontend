...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen transition-colors duration-500 selection:bg-emerald-500/30 antialiased font-['Poppins',sans-serif] bg-[#050505] text-white">
      ...
      <section
        id="protocol"
        className="py-32 px-6 border-t transition-colors border-white/5 bg-[#080808]"
      >
      ...
      <section
        id="who"
        className="py-24 md:py-32 px-4 md:px-6 border-t border-white/5 bg-[#060606]"
      >
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <motion.div
          ...
          >
            {[
              ...
              <motion.div
                key={c.title}
                variants={fadeInUp}
                className="group relative rounded-3xl border border-white/10 bg-white/2 overflow-hidden hover:bg-white/3 hover:border-white/20 transition-all"
              >
                {/* subtle top accent */}
      ...
      <section
        id="faq"
        className="py-24 md:py-32 px-4 md:px-6 border-t border-white/5 bg-[#050505]"
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/2 px-4 py-3 self-start md:self-end">
          ...
          <div className="divide-y divide-white/10 rounded-3xl border border-white/10 overflow-hidden bg-white/2">
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 md:px-8 py-6 flex items-center justify-between gap-6 text-left hover:bg-white/3 transition-colors"
                    type="button"
                  >
                    ...
                    <div className="shrink-0 w-9 h-9 rounded-full border border-white/10 bg-black/20 flex items-center justify-center">
                      {open ? (
