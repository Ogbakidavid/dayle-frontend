  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-sm font-black text-slate-500 uppercase tracking-[0.2em]">
          <Link
            href="/freelancer"
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          <div className="py-20 text-center bg-[#111111] border border-gray-900 rounded-sm">
            ...
            <p className="text-gray-400 font-medium text-lg text-white">
