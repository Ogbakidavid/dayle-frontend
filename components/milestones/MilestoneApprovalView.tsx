...
export function MilestoneApprovalView({ vaultId, milestoneId, role }: MilestoneApprovalViewProps) {
    ...
    const handleReview = async (outcome: 'APPROVE' | 'REQUEST_CHANGES' | 'REJECT') => {
