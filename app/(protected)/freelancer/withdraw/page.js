            ...
            <div className="flex flex-col lg:flex-row min-h-screen">
                ...
                <aside className="w-full lg:w-[350px] bg-[#080808] p-10 border-r border-white/5 flex flex-col justify-between">
                    <div className="space-y-12">
                        ...
                        <div className="space-y-8">
                            <div className="space-y-1">
                                <p className="text-xs font-black uppercase text-white/40 tracking-[0.2em]">Settlement Amount</p>
                    ...
                    <div className="p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                        <div className="flex items-center gap-2 text-emerald-500 text-xs font-black uppercase tracking-[0.2em] mb-2">
                    ...
                    <div className="max-w-4xl mx-auto w-full">
                        ...
                        {(step === 'initiation' || step === 'card') && (
                            <button
                                ...
                                className="flex items-center gap-2 text-white/50 hover:text-emerald-500 transition-all text-xs font-black uppercase tracking-widest mb-12 group"
                            >
                            ...
                            {step === 'method_selection' && (
                                ...
                                >
                                    <div className="text-center space-y-2">
                                        ...
                                        <p className="text-xs font-bold text-white/20 uppercase tracking-widest">Select how you want to receive your funds</p>
                                    </div>
                                ...
                                <motion.div key="card" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="grid md:grid-cols-2 gap-16 items-center">
                                    ...
                                    <div className="space-y-8">
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs font-bold text-white/20 uppercase tracking-widest">Funds will be pushed to this card instantly.</p>
                                        </div>
                                        ...
                                        <Button onClick={handleCardSubmit} className="w-full h-14 bg-emerald-500 hover:bg-emerald-400 text-black font-black uppercase text-xs tracking-widest rounded-xl transition-all shadow-xl shadow-emerald-500/10">Proceed to Review <ArrowRight className="w-4 h-4 ml-2" /></Button>
                                    </div>
                                </motion.div>
                            )}
                                ...
                                >
                                    <div className="space-y-4 flex flex-col items-center">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs font-bold text-white/20 uppercase tracking-widest">Select your payout destination and currency</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full max-w-md space-y-8">
                                        <div className="grid grid-cols-1 gap-6">
                                            <div className="space-y-2">
                                                <label className="text-xs font-black text-white/20 uppercase tracking-[0.2em] block text-left ml-1">Payout Country</label>
                                                <select
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-xs font-black text-white/20 uppercase tracking-[0.2em] block text-left ml-1">Payout Currency</label>
                                                <select
                                        ...
                                        <Button
                                            ...
                                            className="w-full h-14 bg-emerald-500 hover:bg-emerald-400 text-black font-black uppercase text-xs tracking-widest rounded-xl transition-all shadow-xl shadow-emerald-500/10"
                                        >
                                ...
                                >
                                    <div className="space-y-4 flex flex-col items-center text-center">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs font-bold text-white/20 uppercase tracking-widest">Configure your bank destination for this settlement</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-10 w-full items-center">
                                        <div className="space-y-8">
                                            <div className="space-y-6">
                                                <div className="space-y-2">
                                                    <label className="text-xs font-black text-white/20 uppercase tracking-[0.2em] ml-1">Bank Name</label>
                                                    <input
                                                        type="text"
                                                ...
                                                <div className="space-y-2">
                                                    <label className="text-xs font-black text-white/20 uppercase tracking-[0.2em] ml-1">Account Number</label>
                                                    <input
                                                        type="text"
                                            ...
                                            {showOtp ? (
                                                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="space-y-8 bg-white/[0.02] border border-white/5 p-8 rounded-3xl">
                                                    <div className="space-y-2">
                                                        ...
                                                        <p className="text-xs text-white/50 leading-relaxed font-bold uppercase tracking-widest">Account: <span className="text-emerald-500">{bankDetails.accountName}</span></p>
                                                    </div>
                                                    ...
                                                    <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-2xl">
                                                        <p className="text-xs text-blue-300 text-center font-bold uppercase tracking-widest leading-relaxed">Identity Check: Use code <span className="text-white">123456</span> for demo verification</p>
                                                    </div>

                                                    <button
                                                        onClick={handleVerifyOtp}
                                                        className="w-full h-12 bg-white text-black font-black uppercase text-xs tracking-widest rounded-xl hover:bg-slate-200 transition-all shadow-xl active:scale-95"
                                                    >
                                                        Confirm Identity
                                                    </button>
                                                </motion.div>
                                                ...
                                                <div className="h-full flex flex-col items-center justify-center text-center p-8 bg-white/[0.01] border border-dashed border-white/5 rounded-3xl">
                                                    ...
                                                    <p className="text-xs font-black text-white/20 uppercase tracking-[0.2em]">Awaiting Verification</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="text-center space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs font-bold text-white/20 uppercase tracking-widest px-10">Confirm the details below. Settlements are irreversible once processed by the bank network.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Button variant="ghost" onClick={() => setStep('verification')} className="h-14 font-black uppercase text-xs tracking-widest text-white/40 hover:text-white hover:bg-white/5 rounded-xl transition-all">
                                            Modify Details
                                        </Button>
                            ...
                            {step === 'success' && (
                                <motion.div key="success" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-lg mx-auto text-center space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-xs font-bold text-white/20 uppercase tracking-widest leading-relaxed">Your settlement has been authorized and dispatched.</p>
                                    </div>
                                    ...
                                    <div className="bg-[#111111] border border-gray-900 rounded-3xl p-8 space-y-6">
                                        ...
                                        <div className="pt-6 border-t border-white/5 flex justify-between items-center text-xs font-black uppercase tracking-widest">
                                            <span className="text-white/40">Transaction ID</span>
                                            <span className="text-white font-mono">{transactionId}</span>
                                        </div>
                                    </div>

                                    <Button onClick={() => router.push('/freelancer/wallet')} className="w-full h-16 bg-white text-black font-black uppercase text-xs tracking-widest rounded-2xl hover:bg-slate-200 transition-all shadow-xl active:scale-95">
                                        Back to Dashboard
                                    </Button>
                                </motion.div>
                            )}
                            ...
                            {step === 'failure' && (
                                <motion.div key="failure" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-lg mx-auto text-center space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-xs font-bold text-white/20 uppercase tracking-widest leading-relaxed">The bank network rejected the settlement or the connection timed out.</p>
                                    </div>

                                    <div className="p-6 bg-red-500/10 border border-red-500/20 rounded-3xl text-left space-y-3">
                                        <p className="text-xs font-black text-white uppercase tracking-widest">Reject Code: SET_FAIL_BANK_COMM_ERR</p>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Button variant="outline" onClick={() => { setStep('verification'); setShowOtp(false); setOtp(['', '', '', '', '', '']); }} className="h-14 font-black uppercase text-xs tracking-widest border-white/10 hover:bg-white/10 rounded-xl transition-all">
                                            Retry Transfer
                                        </Button>
    ...
    return (
        <button onClick={onClick} className="w-full p-6 bg-white/[0.03] border border-white/5 rounded-3xl flex items-center gap-6 group hover:bg-emerald-500/5 hover:border-emerald-500/30 transition-all text-left">
            ...
            <div className="flex-1">
                ...
                <p className="text-xs font-bold text-white/20 uppercase tracking-widest mt-1">{desc}</p>
            </div>
...
function WithdrawInputField({ label, error, ...props }) {
    return (
        <div className="space-y-2">
            <label className="text-xs font-black uppercase text-white/20 tracking-[0.2em] ml-1">{label}</label>
            <input {...props} className={cn("w-full bg-white/[0.03] border h-14 rounded-xl px-5 text-white focus:border-emerald-500/50 outline-none transition-all font-black uppercase tracking-widest text-xs placeholder:text-white/10", error ? 'border-red-500' : 'border-white/10')} />
...
function ReviewItem({ label, value, subValue, highlight }) {
    return (
        <div className="p-6 flex justify-between items-center">
            <span className="text-xs font-black uppercase text-white/40 tracking-widest">{label}</span>
            <div className="text-right">
                <p className={cn("font-black text-white text-xs uppercase tracking-tight", highlight)}>{value}</p>
        ...
        <div className="space-y-12">
            <div className="text-center space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-xs font-bold text-white/20 uppercase tracking-[0.3em]">Reference: {transactionId}</p>
                </div>
            </div>
                ...
                {steps.map((step, idx) => (
                    <div key={idx} className="flex gap-6 relative">
                        ...
                        <div className="pt-1.5 flex-1">
                            <h4 className={cn("font-black text-xs tracking-[0.2em] uppercase", step.status === 'pending' ? 'text-white/10' : 'text-white')}>{step.label}</h4>
...
function ProcessingOverlay() {
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs font-black uppercase tracking-[0.4em] text-emerald-500/60">Bio-Verified Protocol</p>
        </motion.div>
    );
}
