    ...
    useEffect(() => {
        async function loadData() {
            try {
                ...
                // 2. Get Invite Data
                if (inviteToken) {
                    const result = await api.invites.getByToken(inviteToken) as InviteData;
                    setData(result);
                }
            } catch (err: any) {
                ...
                <div className="w-full max-w-4xl grid md:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="bg-muted border border-white/5 rounded-2xl p-6 md:p-8 space-y-8 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-xs font-black uppercase tracking-widest text-white/40 mb-6 font-['Poppins',sans-serif]">Safe Project Summary</h3>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="text-3xl font-black text-white tracking-tight flex items-baseline gap-2">
                                        ...
                                        <span className="text-sm font-bold text-white/30 uppercase font-['Poppins',sans-serif]">Phases</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        {!isLoggedIn ? (
                            ...
                            <div className="text-center space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/50 text-sm mt-2 font-medium">You are logged in as a Client. This invitation is intended for a Freelancer account.</p>
                                </div>
                                <div className="grid gap-3">
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                        ...
                        >
                            <div>
                                ...
                                <p className="text-white/50 text-sm mt-1 font-medium">Please select a reason for declining.</p>
                            </div>
