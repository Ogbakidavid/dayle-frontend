...
export default function LoginPage() {
  ...
  const { sendCode, loginWithCode, state } = useLoginWithEmail({
    onComplete: (user) => {
      console.log("Login with code complete", user);
    },
    onError: (error) => {
      setLoading(false);
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The onComplete callback or the useEffect watching 'authenticated' will handle the rest
    } catch (err) {
      console.error("handleOtpSubmit error:", err);
          ...
          {!isAwaitingCode ? (
            ...
            >
              ...
              <Button
                ...
                className="w-full h-16 bg-emerald-600 text-white hover:bg-emerald-700 rounded-2xl font-bold text-base transition-all shadow-xl active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
              >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-slate-900 font-bold  st group-hover:text-slate-900 transition-colors">
                    Google
                  </span>
                </Button>
            ...
            >
              <div className="space-y-3">
                ...
                <p className="text-sm text-white/50 font-bold  ml-1">
