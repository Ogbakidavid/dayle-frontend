    ...
    return (
        <div className="min-h-screen transition-colors duration-500 selection:bg-emerald-500/30 antialiased font-['Poppins',_sans-serif] bg-[#050505] text-white">
            ...
            <section className="relative pt-48 pb-32 px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center relative z-10">
                    ...
                    <div className="lg:col-span-7 text-left">
                        ...
                        <p className="text-lg md:text-2xl max-w-xl mb-12 font-bold leading-relaxed tracking-tight text-white/40 uppercase">
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        {[
                            ...
                            <div key={i} className="p-12 border rounded-[48px] relative group transition-all bg-white/[0.02] border-white/5 hover:bg-white/[0.04]">
                                ...
                                <p className="text-lg font-bold leading-relaxed text-white/40 uppercase tracking-tight">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
                        <div className="max-w-2xl">
                            ...
                            <p className="font-bold text-xl leading-relaxed text-white/40 uppercase tracking-tight">
            ...
            <footer className="py-32 px-6 border-t transition-colors border-white/5 bg-black">
                ...
                <div className="max-w-7xl mx-auto mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[10px] font-black text-white/10 uppercase tracking-[0.3em]">
