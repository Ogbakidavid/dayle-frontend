        ...
        <div className="w-full max-w-[440px] relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-3">
              ...
              <div className="relative group">
                <Input
                  ...
                  required
                  className="!bg-[#0a0a0a] border-white/10 h-16 rounded-2xl px-6 focus:border-emerald-500/50 focus:!bg-white/[0.05] focus:ring-0 transition-all !text-white text-lg placeholder:text-white/50 autofill:shadow-[0_0_0_1000px_#0a0a0a_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:white]"
                />
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <PasswordInput
                  ...
                  placeholder="••••••••"
                  required
                  className="!bg-[#0a0a0a] border-white/10 h-16 rounded-2xl px-6 focus:border-emerald-500/50 focus:!bg-white/[0.08] focus:ring-0 transition-all !text-white text-lg placeholder:text-gray-400 autofill:shadow-[0_0_0_1000px_#0a0a0a_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:white]"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <Button
                type="button"
                className="w-full h-16 bg-white/5 border border-white/10 hover:bg-white/10 hover:text-white rounded-2xl font-black text-sm uppercase tracking-wide transition-all flex items-center justify-center gap-3 text-white"
              >
              ...
              >
                <svg className="w-6 h-6 fill-white shrink-0" viewBox="0 0 24 24">
                  <path d="M17.05 20.28c-.96.95-2.01 1.72-3.14 1.72-1.13 0-1.5-.69-2.79-.69s-1.7.67-2.77.67c-1.08 0-2.12-.77-3.21-1.78C2.97 18.15 1 14.54 1 11.23c0-3.34 2.1-5.11 4.14-5.11 1.05 0 2.05.4 2.65.69.6.29 1.48.56 2.21.56.73 0 1.58-.27 2.18-.56.6-.29 1.6-.69 2.65-.69 1.83 0 3.19.98 3.93 2.1-.21.1-.73.4-1.12.75-.82.72-1.25 1.73-1.25 2.76 0 1.25.6 2.38 1.57 3.03l.36.21c-.24.78-.65 1.6-1.24 2.31zM11.91 5.92c-.04 0-.08 0-.12-.01-.13-.02-.27-.05-.41-.1-.7-.34-1.21-1.03-1.21-2.07 0-.35.08-.82.35-1.26.47-.76 1.34-1.3 2.32-1.3.1 0 .2 0 .29.01.12.01.25.04.38.07.66.31 1.15.96 1.15 1.96 0 .42-.1.97-.43 1.48-.48.81-1.39 1.22-2.32 1.22z" />
                </svg>
                Apple
              </Button>
            </div>
