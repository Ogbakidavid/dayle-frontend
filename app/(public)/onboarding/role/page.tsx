            ...
            <div className="relative z-10 w-full max-w-4xl">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div
                        ...
                        className={`group relative p-10 rounded-[40px] border transition-all cursor-pointer overflow-hidden ${loading === UserRole.CLIENT ? "border-emerald-500 bg-emerald-500/5" : "border-white/10 bg-muted hover:border-emerald-500/50 hover:bg-[#0f0f0f]"
                            }`}
                    >
                    ...
                    <div
                        ...
                        className={`group relative p-10 rounded-[40px] border transition-all cursor-pointer overflow-hidden ${loading === UserRole.FREELANCER ? "border-emerald-500 bg-emerald-500/5" : "border-white/10 bg-muted hover:border-emerald-500/50 hover:bg-[#0f0f0f]"
                            }`}
                    >
                        <div className="relative z-10">
                            <div className="w-16 h-16 rounded-2xl bg-white/3 border border-white/10 flex items-center justify-center mb-8 group-hover:bg-emerald-500/10 group-hover:border-emerald-500/20 transition-all">
