...
export default function SupportPage() {
    return (
        <section className="min-h-screen bg-black px-4 md:px-6 pt-32 pb-24">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="text-white font-black tracking-tight text-lg">
                ...
                <div className="mt-14">
                    <Link href="/">
                        <Button
                            variant="ghost"
                            className="text-sm font-black uppercase tracking-wide text-white hover:bg-white/[0.06]"
                        >
                            ← Back to Dayle
                        </Button>
                    </Link>
