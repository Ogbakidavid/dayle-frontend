              ...
              >
                ...
                <div className="flex items-center gap-6">
                  <div className="text-right">
                    <p className="text-sm text-gray-400 font-bold uppercase tracking-wider mb-1">Vault Value</p>
              ...
              <div className="mt-6 flex items-center justify-between px-2">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="h-8 px-3 text-[10px] border-gray-800 bg-transparent hover:bg-gray-800 text-gray-400 font-bold uppercase tracking-wider"
                  >
                    Previous
                  </Button>
                  <Button
