  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <motion.aside
        ...
        className={cn(
          "w-[300px] xl:w-[320px] border-r border-white/10 bg-emerald-950 flex flex-col h-screen transition-transform duration-300 ease-in-out shadow-2xl shadow-emerald-950/20",
