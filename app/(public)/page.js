...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen transition-colors duration-500 selection:bg-emerald-500/30 antialiased font-['Poppins',_sans-serif] bg-[#050505] text-white">
            ...
            {/* Navigation */}
            <nav className="fixed top-3 md:top-6 inset-x-0 z-[100] max-w-7xl mx-auto px-3 md:px-6 font-sans">
            ...
            <section className="relative pt-24 md:pt-32 lg:pt-48 pb-16 md:pb-24 lg:pb-32 px-4 md:px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center relative z-10">
                    ...
                    <div className="lg:col-span-7 text-left">
                        <div className="inline-flex items-center gap-2 px-3 md:px-5 py-2 md:py-2.5 rounded-full border text-xs md:text-sm font-black uppercase tracking-wide mb-6 md:mb-8 bg-emerald-500/10 border-emerald-500/20 text-emerald-400">
                            <Activity className="w-3 h-3 md:w-4 md:h-4" /> Eliminating Counterparty Risk
                        </div>

                        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[90px] font-black tracking-tighter leading-[0.9] md:leading-[0.85] mb-6 md:mb-8 uppercase text-white">
                            Autonomous <br />
                            <span className="text-emerald-500 italic">Settlement.</span> <br />
                            Zero Friction.
                        </h1>

                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl max-w-xl mb-8 md:mb-12 font-bold leading-relaxed tracking-tight text-white uppercase">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
                        {[
                            ...
                            <div key={i} className="p-6 md:p-10 lg:p-12 border rounded-3xl md:rounded-[48px] relative group transition-all bg-white/[0.02] border-white/5 hover:bg-white/[0.04]">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        {[
                            ...
                            <div key={i} className="p-6 md:p-8 lg:p-10 border rounded-2xl md:rounded-3xl lg:rounded-[40px] transition-all group bg-[#0a0a0a] border-white/10 hover:border-emerald-500/50">
            ...
            <section id="safety" className="py-16 md:py-24 lg:py-32 px-4 md:px-6">
                <div className="max-w-7xl mx-auto border rounded-3xl md:rounded-[60px] p-6 md:p-12 lg:p-24 relative overflow-hidden transition-all bg-[#0a0a0a] border-white/10">
                    <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-center relative z-10">
                        ...
                        <div className="space-y-3 md:space-y-4">
                            {[
                                ...
                                <div key={i} className="bg-white/5 border border-white/10 p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl flex items-center justify-between hover:bg-white/10 transition-colors cursor-pointer group">
