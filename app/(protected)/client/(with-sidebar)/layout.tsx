...
const navigation: NavItem[] = [
    ...
    { name: "Vaults", href: "/client/vaults", icon: Lock, badge: null },
        ...
        <div className="min-h-screen bg-background text-white flex">
            ...
            <motion.aside
                ...
                <div className="p-6 pb-4">
                    <Link href="/client" className="flex items-center gap-3 group font-['Poppins',sans-serif]">
                ...
                <div className="p-4 border-t border-gray-900 mt-auto font-['Poppins',sans-serif]">
                    <div className="flex items-center gap-3 p-3 rounded-lg">
                        ...
                        <div>
                            <p className="text-sm font-bold uppercase tracking-wide text-white">{user?.name}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4">
                        <Link href="/client/settings" className="relative group">
                            <Button
                                variant="outline"
                                size="sm"
                                className="h-9 w-full text-sm font-bold uppercase tracking-wide border-white/10 bg-black/30 hover:bg-white/10 hover:border-white/20 text-white/80 transition-all font-['Poppins',sans-serif]"
                            >
                        ...
                        <Button
                            ...
                            size="sm"
                            onClick={logout}
                            className="h-9 text-sm font-bold uppercase tracking-wide border-white/10 bg-black/30 hover:bg-red-500/10 hover:border-red-500/30 hover:text-red-400 transition-all font-['Poppins',sans-serif]"
                        >
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="lg:hidden sticky top-0 z-30 bg-muted border-b border-gray-900 p-4 flex items-center justify-between">
                    ...
                    <h1 className="text-lg font-bold uppercase font-['Poppins',sans-serif]">Dayle</h1>
