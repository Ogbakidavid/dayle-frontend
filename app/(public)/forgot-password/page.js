...
import { Shield, ArrowRight, Loader2, CheckCircle2, User, ArrowLeft } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#050505] flex flex-col md:flex-row selection:bg-emerald-500/30 font-['Poppins',_sans-serif]">
            ...
            <div className="hidden md:flex md:w-[45%] bg-[#080808] relative justify-center p-20 border-r border-white/5 overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-lg">
                    ...
                    <div className="space-y-8">
                        {[
                            { title: "Account Security", text: "We verify your identity before resetting access." },
                            { title: "Instant Recovery", text: "Receive a secure reset link to your email instantly." },
                            { title: "24/7 Support", text: "Contact our dedicated support team if you need help." }
                        ].map((item, i) => (
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 md:p-24 bg-[#050505] relative overflow-hidden">
                ...
                <div className="w-full max-w-[440px] relative z-10">
                    <Link href="/login" className="inline-flex items-center gap-2 text-white/50 hover:text-emerald-500 mb-8 font-black uppercase tracking-wide text-xs transition-colors group">
                        <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" /> Back to Login
                    </Link>

                    <div className="mb-12">
                        <h2 className="text-4xl font-black text-white tracking-tight uppercase leading-none">Forgot Password</h2>
                        <p className="text-white mt-4 text-sm font-bold uppercase tracking-wide leading-relaxed">Enter your email to receive a password reset link.</p>
                    </div>
                    ...
                    {!submitted ? (
                        ...
                        <div className="bg-[#111111] border border-white/10 p-8 rounded-3xl text-center space-y-6 animate-in fade-in slide-in-from-bottom-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-black text-white uppercase tracking-tight">Link Sent!</h3>
                            ...
                            <div className="pt-4 border-t border-white/5">
                                <Link href="/reset-password" className="text-emerald-500 text-xs font-black uppercase tracking-wide hover:underline">
