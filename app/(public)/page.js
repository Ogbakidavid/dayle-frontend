            ...
            <section className="relative pt-48 pb-32 px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center relative z-10">
                    ...
                    <div className="lg:col-span-7 text-left">
                        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border text-sm font-black uppercase tracking-wide mb-8 bg-emerald-500/10 border-emerald-500/20 text-emerald-400">
                        ...
                        <p className="text-lg md:text-2xl max-w-xl mb-12 font-bold leading-relaxed tracking-tight text-white uppercase">
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        {[
                            ...
                            <div key={i} className="p-12 border rounded-[48px] relative group transition-all bg-white/[0.02] border-white/5 hover:bg-white/[0.04]">
                                ...
                                <p className="text-lg font-bold leading-relaxed text-white uppercase tracking-tight">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="p-10 border rounded-[40px] transition-all group bg-[#0a0a0a] border-white/10 hover:border-emerald-500/50">
                                ...
                                <p className="text-sm leading-relaxed font-bold text-white uppercase tracking-wide">{f.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto border rounded-[60px] p-12 md:p-24 relative overflow-hidden transition-all bg-[#0a0a0a] border-white/10">
                    <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
                        <div>
                            ...
                            <p className="text-white text-sm font-bold uppercase tracking-wide leading-loose mb-12">Your project capital is protected by bank-grade infrastructure and isolated vaults.</p>
                            <div className="grid grid-cols-2 gap-6 text-white">
                                {['AES-256 Encryption', 'Biometric MFA', 'SOC-2 Compliant', 'Insured Vaults'].map((text, i) => (
                                    <div key={i} className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-black uppercase tracking-wide">{text}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                            ...
                            {[
                                ...
                                <div key={i} className="bg-white/5 border border-white/10 p-8 rounded-3xl flex items-center justify-between hover:bg-white/10 transition-colors cursor-pointer group">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="text-sm font-black uppercase text-white tracking-wide">{item.title}</span>
                                    </div>
                                    <ArrowUpRight className="w-6 h-6 text-white group-hover:text-emerald-500 transition-colors" />
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <footer className="py-32 px-6 border-t transition-colors border-white/5 bg-black">
                <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-20">
                    <div className="col-span-2 space-y-10">
                        ...
                        <p className="text-white text-sm font-black max-w-sm leading-relaxed uppercase tracking-wide">Infrastructure for the global workforce.</p>
                    </div>
                    <div>
                        <h4 className="text-sm font-black uppercase tracking-wide mb-10 text-white">Platform</h4>
                        <ul className="space-y-4 text-sm text-white font-black uppercase tracking-wide">
                    ...
                    <div>
                        <h4 className="text-sm font-black uppercase tracking-wide mb-10 text-white">Contact</h4>
                        <ul className="space-y-4 text-sm text-white font-black uppercase tracking-wide">
                ...
                <div className="max-w-7xl mx-auto mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-sm font-black text-white uppercase tracking-[0.3em]">
